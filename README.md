...
> ⚠️ This is a forked and republished version of
...
> I'm linking to
> [my forked version of the docs](https://collisions.ryanatkn.com/)
...
View the [documentation](https://collisions.ryanatkn.com/) (this README is also there).

<a name="anchor-demos"></a>
Demos
===============================================================================

- [Tank](https://collisions.ryanatkn.com/demo/)
- [Stress Test](https://collisions.ryanatkn.com/demo/?stress)
...
There is often a need for detailed information about a collision in order to react to it appropriately. This information is stored using a `Result` object. `Result` objects have several properties set on them when a collision occurs, all of which are described in the [documentation](https://collisions.ryanatkn.com/).
...
Padding can be added to a body when instantiating it (see the [documentation](https://collisions.ryanatkn.com/) for each body) or at any time by changing its `padding` property.
